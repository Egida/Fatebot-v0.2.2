...
<p><strong>Fatebot v0.2d:</strong> Add multiple ddos function like UDP and Post flood at The same time.(I know it really stupid.), This is a very little update just put some thread into a ddos function and "d" mean very little update</p>
