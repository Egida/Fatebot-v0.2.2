...
<p><strong>Fatebot v0.2d:</strong> Add multiple ddos function like UDP and Post flood at The same time.(I know it really stupid.), And add turotial in to "main", "ddos" and "scan" files</p>
