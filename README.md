...
# Fatebot v0.3
This is my first IRC bot for launch ddos attack, Mainly of scan target are IoT device that run linux and open default SSH port.(Scope on CHN by default.), Write on Go language. For education purpose only. Please test it in your lab. And i create this for join university in the future not for attack anyone server with out any permission!!!
