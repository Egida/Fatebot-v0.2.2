...
<p><strong>Fatebot v0.3.1</strong> = Fix and cut some function of vse and post flood. Fix IRC configuration that will make a little easy to config and change project layout.</p>
